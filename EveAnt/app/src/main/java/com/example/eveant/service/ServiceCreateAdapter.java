...
public class ServiceCreateAdapter extends RecyclerView.Adapter<ServiceCreateAdapter.ServiceViewHolder> {

    private ArrayList<Service> serviceList;
    private Fragment fragment;
    public ServiceCreateAdapter(ArrayList<Service> serviceList) {
        this.serviceList = serviceList;
    }

    public ServiceCreateAdapter(ArrayList<Service> serviceList, Fragment fragment) {
        this.serviceList = serviceList;
